...
<head>
    ...
    <title>Form Tampil Department</title>
    ...
    <div class="wrapper">
            ...
            <div class="content-header">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                    <h1 class="m-0"><b>Data Department</b></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        $result = mysqli_query($db, "select * from departemen");
            ...
            <div class="card-body mr-5">
                <a href="../Add/tambah_departemen.php" class="btn btn-outline-primary btn-sm mb-3">Tambah</a>
                <!-- /.card-header -->
                    ...
                    <table class="table table-hover text-nowrap">
                        <thead class="bg-dark">
                            <tr>
                                ...
                                <th scope="col">Alamat Department</th>
                        ...
                        <?php
                            ...
                            while($user_data = mysqli_fetch_array($result)) {
                                // while($user_data2 = mysqli_fetch_array($result2)) {
                                    echo "<tr>";
                                    echo "<td>".$i++."</td>";
                                    echo "<td>".$user_data[('Id_Departemen')]."</td>";
                                    echo "<td>".$user_data[('Kode_Departemen')]."</td>";
                                    echo "<td>".$user_data[('Nama_Departemen')]."</td>";
                                    echo "<td>".$user_data[('Alamat_Departemen')]."</td>";
                                    echo "<td><center><a class='btn btn-outline-warning' href='../edit/edit_departemen.php?Id_Departemen=$user_data[Id_Departemen]'>Edit</a>
                                        <a class='btn btn-outline-danger ml-3' href='../Delete/deletedepartemen.php?Id_Departemen=$user_data[Id_Departemen]'>Delete</a></center></td></tr>";
                                }
