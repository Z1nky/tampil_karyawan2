...
<head>
    ...
    <title>Form Tampil Karyawan</title>
    ...
    <!-- Brand Logo -->
    <a href="tampil_karyawan.php" class="brand-link">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0"><b>Data Karyawan</b></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    $result = mysqli_query($db, "select * from karyawan");
        ...
        <div class="card-body mr-5" >
            <a href="../Add/tambah_karyawan.php" class="btn btn-outline-primary btn-sm mb-3">Tambah</a>
            <!-- /.card-header -->
                    ...
                    <?php
                        ...
                        while($user_data = mysqli_fetch_array($result)) {
                            // while($user_data2 = mysqli_fetch_array($result2)) {
                                ...
                                echo "<td><center><a class='btn btn-outline-warning' href='../edit/edit_karyawan.php?Id_Karyawan=$user_data[Id_Karyawan]'>Edit</a>
                                <a class='btn btn-outline-danger ml-3' href='../Delete/deletekaryawan.php?Id_Karyawan=$user_data[Id_Karyawan]'>Delete</a></center></td></tr>";
