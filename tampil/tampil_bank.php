...
<head>
    ...
    <div class="card-body mr-5">
        <a href="../Add/tambah_bank.php" class="btn btn-outline-primary btn-sm mb-3">Tambah</a>
                    <!-- /.card-header -->
                <div class="card-body table-responsive p-0">
                    ...
                    <?php
                        ...
                        while($user_data = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>".$user_data[('Kode_Bank')]."</td>";
                            echo "<td>".$user_data[('Gaji')]."</td>";
                            echo "<td><center><a class='btn btn-outline-warning' href='../edit/edit_bank.php?Id_Bank=$user_data[Id_Bank]'>Edit</a>
                                <a class='btn btn-outline-danger ml-3' href='../Delete/deletebank.php?Id_Bank=$user_data[Id_Bank]'>Delete</a></center></td></tr>";
                            }
                    ?>      
                    </tbody>
                    </table>
