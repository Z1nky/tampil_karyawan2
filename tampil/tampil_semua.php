...
<head>
    ...
    <div class="wrapper">
        ...
        <div class="content-header">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                <h1 class="m-0"><b>Data All</b></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">All</a></li>
                    <li class="breadcrumb-item active">Data All</li>
                </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            </div><!-- /.container-fluid -->
    ...
    $result = mysqli_query($db, "SELECT A.Nama AS 'Nama Karyawan', B.Nama_Departemen AS 'Nama Department', C.Nama_Branch AS 'Branch',
    D.Nama_Bank AS 'Bank', A.Alamat AS 'Alamat', D.Gaji AS 'Gaji' FROM karyawan A 
    INNER JOIN departemen B ON A.Id_Departemen = B.Id_Departemen 
    INNER JOIN branch C ON a.Id_Branch = C.Id_Branch
    INNER JOIN bank D on a.Id_Bank = D.Id_Bank;");
                    ...
                    <?php
                        ...
                        while($user_data = mysqli_fetch_array($result)) {
                            // while($user_data2 = mysqli_fetch_array($result2)) {
                                echo "<tr>";
                                echo "<td>".$i++."</td>";
                                echo "<td>".$user_data[('Nama Karyawan')]."</td>";
                                echo "<td>".$user_data[('Nama Department')]."</td>";
                                echo "<td>".$user_data[('Branch')]."</td>";
                                echo "<td>".$user_data[('Bank')]."</td>";
